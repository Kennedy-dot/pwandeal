 ...
 * Refined for Schema Consistency and Secure Uploads
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($title) < 5 || strlen($title) > 100) {
        ...
        try {
            ...
            $image_name = 'service-placeholder.jpg';
            if (isset($_FILES['service_image']) && $_FILES['service_image']['error'] === 0) {
                ...
                if (in_array($ext, $allowed)) {
                    ...
                    if (move_uploaded_file($_FILES['service_image']['tmp_name'], $upload_dir . $image_name)) {
                        // Insert into listing_images table (Primary Image)
            ...
            echo "<script>setTimeout(() => { window.location.href = 'view.php?id=$listing_id'; }, 2000);</script>";
                    ...
                    <form method="POST" enctype="multipart/form-data" id="postForm">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="title" class="form-control form-control-lg" placeholder="What are you offering?" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="price" class="form-control form-control-lg" placeholder="0.00" step="1">
                                <small class="text-muted">Enter 0 if the price is negotiable.</small>
                            </div>

                            <div class="col-12">
                                <label class="form-label fw-bold">Detailed Description</label>
                                <textarea name="description" id="description" class="form-control" rows="5" placeholder="Include details like location, delivery, or requirements..." required></textarea>
                                <div class="text-end mt-1"><span id="char-count" class="badge bg-light text-dark">0 / 1500</span></div>
                            </div>
...
desc.addEventListener('input', () => {
    document.getElementById('char-count').innerText = `${desc.value.length} / 1500`;
});

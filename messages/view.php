...
// This query groups by user to show unique conversation threads
$sql = "SELECT 
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-primary py-4 border-0">
                    <div class="d-flex justify-content-between align-items-center px-2">
                        ...
                        <span class="badge bg-accent text-dark rounded-pill">
                ...
                <div class="card-body p-0">
                                   ...
                                   class="list-group-item list-group-item-action p-4 border-0 border-bottom">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-4 flex-grow-1 min-width-0">
                                            ...
                                            <p class="mb-0 text-muted text-truncate <?= ($conv['unread_count'] > 0) ? 'fw-bold text-dark' : '' ?>" style="max-width: 90%;">
                                                <?= ($conv['unread_count'] > 0) ? '📩 ' : '' ?>
                    ...
                    <?php else: ?>
                        <div class="text-center py-5 my-5">
                            ...
                            <h4 class="text-secondary">No conversations yet</h4>
